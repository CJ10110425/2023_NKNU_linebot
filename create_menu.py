...
def create_rich_menu(headers, body, image_path):
    ...
    if req.status_code == 200:
        ...
        print(f"表單創建成功，ID為 {rich_menu_id}")
...
def create_initial_menu():#創建初始menu,其中,路徑記得改
    create_menu_from_json('rich_menu_config.json', 'path/to/your/initial_image.jpg(png)', "initial_menu")

def create_professor_menu():#創建教授menu,其中,路徑記得改
    create_menu_from_json('rich_menu_config.json', 'path/to/your/professor_image.jpg(png)', "professor_menu")
